# run_retrieval.py
# Tested with: paper-qa==4.4.0, langchain-core>=0.2.4, httpx, langchain-openai>=0.1.17
# env:
#   export OPENAI_API_KEY=sk-...                  # for chat model
...
if __name__ == "__main__":
    ...
    # LLM (uses OPENAI_API_KEY). Swap if you use another provider.
