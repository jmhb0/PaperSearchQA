...
# env:
#   Start vLLM server: vllm serve Qwen/Qwen2.5-3B-Instruct --host 0.0.0.0 --port 8002
#   export RETRIEVE_URL="http://localhost:8001/retrieve"
#   export RETRIEVE_BEARER_TOKEN="..."            # optional
#   export MAX_FETCH=50                           # optional cap

MAX_SOURCES = 5  # Limit number of document chunks for processing
...
if __name__ == "__main__":
    ...
    # LLM client for local vLLM server with Qwen2.5-3B-Instruct
